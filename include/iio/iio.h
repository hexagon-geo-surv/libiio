 ...
 * @return On success, 0
 * @return On error, a negative error code is returned */
__api __check_ret int iio_buffer_stream_enable(struct iio_buffer_stream *buf_stream);
 ...
 * @return On success, 0
 * @return On error, a negative error code is returned */
__api int iio_buffer_stream_disable(struct iio_buffer_stream *buf_stream);
