...
_buffer_stream_enable = _lib.iio_buffer_stream_enable
_buffer_stream_enable.restype = c_int
_buffer_stream_enable.argtypes = (_BufferStreamPtr,)
_buffer_stream_enable.errcheck = _check_negative

_buffer_stream_disable = _lib.iio_buffer_stream_disable
_buffer_stream_disable.restype = c_int
_buffer_stream_disable.argtypes = (_BufferStreamPtr,)
...
class BufferStream(_IIO_Object):
    ...
    def _set_enabled(self, enabled):
        if enabled:
            _buffer_stream_enable(self._buffer_stream)
        else:
            _buffer_stream_disable(self._buffer_stream)
    ...
    enabled = property(
        ...
        _set_enabled,
        None,
        "Represents the state (enabled/disabled) of the hardware buffer stream.",
    )
