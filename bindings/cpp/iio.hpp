...
public:
    ...
    void enable() {impl::check(iio_buffer_stream_enable(p), "iio_buffer_stream_enable");}
    void disable() {impl::check(iio_buffer_stream_disable(p), "iio_buffer_stream_disable");}
